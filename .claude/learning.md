...
- `/blog`'s header container padding was cut from the sitewide blog-section value `pt-32 pb-20 md:pt-40 md:pb-28` (still used by `/blog/category`, `/blog/label`, `/blog/tags`, `/blog/author`, `/careers`) down to `pt-20 pb-16 md:pt-24 md:pb-20` — user flagged the top whitespace above the hero slider as excessive on this page specifically. **This is a deliberate, page-scoped divergence, not a new sitewide value** — the other blog landing pages were left untouched. If a future pass wants the compact header everywhere, change all of them together and update this entry rather than letting them drift apart silently.
