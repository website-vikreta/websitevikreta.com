      ...
      <div className="container">
        <div className="grid grid-cols-1 lg:grid-cols-[2fr_3fr] gap-12 lg:gap-20 lg:items-start">
          ...
          <div className='md:py-8'>
            ...
            >
              Let&rsquo;s Get You Found
            </h2>
            <p className="cta-sub text-body-lg text-(--color-text-muted) leading-relaxed mb-4 md:mb-10">
              Tell us where you&rsquo;re ranking today. We&rsquo;ll give you a straight answer on what it takes to move.
            </p>
          </div>
          ...
          <div>
            <div className="cta-form-card bg-(--color-surface) border border-(--color-border) p-5 sm:p-6 md:p-8">
              <AuditForm
                formName="book_digital_marketing_call_inline"
                heading="Book a Free Project Call"
                subjectPlaceholder="What are you trying to rank for?"
                messagePlaceholder="Tell us about your business and current marketing…"
              />
            </div>
          </div>
