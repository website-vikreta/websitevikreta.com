...
export default function Hero() {
  ...
  return (
    <section
      ...
      aria-label="Web & Mobile Apps / CRM Systems"
    >
      <div
        ref={contentRef}
      ...
      >
        ...
        >
          Your Business{' '}
          <span style={{ color: 'var(--color-accent)' }}>Outgrew</span>{' '}
          Its Spreadsheets
        </h1>
        ...
        >
          We build the CRM, portal, or app your team stops working around,
          shaped to how your business already runs.
        </p>
