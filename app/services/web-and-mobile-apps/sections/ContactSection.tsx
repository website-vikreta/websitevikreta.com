...
export default function ContactSection() {
  ...
  async function handleCtaSubmit(e: FormEvent) {
    ...
    try {
      ...
      trackFormSubmit('apps_crm_start_project')
    } catch (err) {
            ...
            <div className="cta-form-card bg-(--color-surface) border border-(--color-border) p-5 sm:p-6 md:p-8">
              {ctaSubmitted ? (
                ...
                <form onSubmit={handleCtaSubmit} noValidate>
                  ...
                  <h3 className="font-sans font-bold text-2xl sm:text-3xl leading-[1.1] text-(--color-text) mb-6">
                  ...
                  <div className="flex flex-col gap-3 sm:gap-3.5">
                    ...
                    <div className="cta-field-row grid grid-cols-1 sm:grid-cols-2 gap-4">
                      ...
                      <div>
                        <label htmlFor="ctaFirstName" className="block text-sm font-medium text-(--color-text-muted) mb-1.5">
                          First Name
                        </label>
                        <input
                          id="ctaFirstName"
                      ...
                      <div>
                        <label htmlFor="ctaLastName" className="block text-sm font-medium text-(--color-text-muted) mb-1.5">
                          Last Name
                        </label>
                        <input
                          id="ctaLastName"
                    ...
                    <div className="cta-field-row">
                      <label htmlFor="ctaEmail" className="block text-sm font-medium text-(--color-text-muted) mb-1.5">
                        Email
                      </label>
                      <input
                        id="ctaEmail"
                    ...
                    <div className="cta-field-row">
                      <label htmlFor="ctaSubject" className="block text-sm font-medium text-(--color-text-muted) mb-1.5">
                        Subject
                      </label>
                      <input
                        id="ctaSubject"
                    ...
                    <div className="cta-field-row">
                      <label htmlFor="ctaMessage" className="block text-sm font-medium text-(--color-text-muted) mb-1.5">
                        Message
                      </label>
                      <textarea
                        id="ctaMessage"
                        ...
                        onChange={handleCtaChange}
                        placeholder="Describe the CRM, portal, or app you need…"
                        rows={5}
                        disabled={ctaSubmitting}
                    ...
                    {ctaSendError && (
                      ...
                      >
                        ...
                        <a
                          ...
                          onClick={() => trackLinkClick('mailto:contact@websitevikreta.com', 'apps_crm_contact_form')}
                        >
