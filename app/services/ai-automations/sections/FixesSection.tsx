...
const FIX_CARDS: FixCard[] = [
  {
    ...
    image:       '/our-services/ai-automation/ai-workflow-automation-diagram.webp',
    stat:        { from: '20h', to: '1h' },
  },
  {
    ...
    image:       '/our-services/ai-automation/ai-generated-ugc-content-automation.webp',
  },
  {
    ...
    image:       '/our-services/ai-automation/whatsapp-ai-agent-automation.webp',
  },
]
      ...
      <div className="container">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 border-t border-l border-(--color-border)">
          {FIX_CARDS.map((card) => (
            <article
              key={card.title}
              className="fix-card group flex h-full flex-col border-r border-b border-(--color-border) bg-(--color-surface) p-5 sm:p-6 transition-[transform,border-color] duration-300 ease-[cubic-bezier(0.16,1,0.3,1)] hover:-translate-y-0.5 hover:border-(--color-border-strong)"
            >
