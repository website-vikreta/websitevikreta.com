...
const WHATSAPP_FAQS: FaqItem[] = [
  ...
  },
  {
    ...
    answer:
      'Both. We audit checkout friction — pricing transparency, guest checkout, UPI placement, page speed — and layer WhatsApp recovery on top. Fixing checkout first often lifts recovery more than messaging alone.',
  },
  {
    id: 'wa-7',
