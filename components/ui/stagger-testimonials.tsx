  ...
  return (
    <div
      ...
      className={cn(
        ...
        isCenter ? "z-10" : "z-0 opacity-90 hover:opacity-100"
      )}
      style={{
        width: cardSize,
        height: cardSize,
        ...
        `,
        boxShadow: isCenter ? "0px 20px 40px -10px rgba(0,0,0,0.4)" : "0px 15px 30px -8px rgba(0,0,0,0.3)"
      }}
    >
      <img
      ...
      <p className="absolute bottom-8 left-8 right-8 mt-2 text-sm italic text-white/70">
        - {testimonial.by}
      </p>
    </div>
  );
